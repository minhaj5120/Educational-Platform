...
<head>
    ...
    <title>Edit Class Teacher</title>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($getTeacher as $classteacher)
                                <div>
                                    <label>
                                        <input type="checkbox" value="{{$classteacher->id}}" name="classteacher_id[]" {{ in_array($classteacher->id, $getAssignTeacherId->pluck('teacher_id')->toArray()) ? 'checked' : '' }}>
                                        {{$classteacher->name}}
                                    </label>
                                </div>
                            @endforeach
