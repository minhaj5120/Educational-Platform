            ...
            <div class="row">
                ...
                <div class="col-lg-3 co-6">
                    <div class='small-box bg-primary' >
                        ...
                        <a href="{{url('admin/assign_subject/list')}}" class="small-box-footer">More info <i class='fas fa-arrow-circle-right'></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 co-6">
                    <div class='small-box bg-dark' >
                        ...
                        <a href="{{url('admin/fees_collection/collect_fees')}}" class="small-box-footer">More info <i class='fas fa-arrow-circle-right'></i></a>
                    </div>
                </div>
