...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 style="font-weight: bold; text-align: left;">Subject List</h1>
                </div>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <a href="{{url('admin/subject/edit/'.$key->id)}}"class="btn btn-primary">Edit</a>
                                          <a href="{{url('admin/subject/delete/'.$key->id)}}"class="btn btn-danger">Delete</a>
