    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-md-12 text-center">
                <h1 style="font-weight: bold;">Chat Box</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="card chat-app">
            <div id="plist" class="people-list">
                <div class="input-group">
                    ...
                    <input type="hidden" id="getReceiverId" value="{{$receiver_id}}">
                </div>
...
$('#getSearchUser').on("click", function (e) {
        var search = $('#getSearch').val();
        var receiver_id = $('#getReceiverId').val();
        
        $.ajax({
            type: "POST",
            url: "{{ route('get_chat_search_user') }}",
            data: {
                'search': search,
